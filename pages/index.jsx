...
Respond ONLY with valid JSON, no markdown:
{
  ...
  // Backend built-in via Next.js API route
        ...
        <div style={{ maxWidth: "920px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "28px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "8px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "6px", padding: "6px 12px", borderRadius: "8px", border: "1px solid #00ff8840", background: "rgba(0,255,136,0.05)" }}>
                <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#00ff88", boxShadow: "0 0 6px #00ff88" }} />
                <span style={{ color: "#00ff88", fontFamily: "'DM Mono', monospace", fontSize: "10px", letterSpacing: "1px" }}>READY</span>
              </div>
                ...
                {activeTab === "main" && (
                  <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                    ...
                    <div style={{ display: "flex", gap: "8px" }}>
                      <button className="btn-primary" onClick={analyzeWithAI} disabled={!audioBuffer || isAnalyzing || isProcessing} style={{ flex: 1 }}>
